...
class StackInfo(object):
   ...
   def get_num_stacks(self):
       #print(self.resource.stacks.all())
   ...
   def get_stack_status(self, stack_name):
       try:
           ...
           print("    Could not find a pre-existing stack named", stack_name)
           return None    
...
if __name__=="__main__":
    ...
    print("Status of stack 'VideoTimeLineDetectionStack':", si.get_stack_status('exampleStackName'))
    print("Outputs of stack 'VideoTimeLineDetectionStack':", si.get_stack_outputs('exampleStackName'))
